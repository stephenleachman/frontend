...
export default function Home() {
  ...
  return (
      <main className="overflow-hidden relative" >
        <PageHeadNav />
        <section id="home" className="px-4 md:px-10 tall:h-screen content-center dark:bg-custom-dark-3 relative border-b-[3px] border-white dark:border-custom-dark-1 hidden md:grid">
          <Hero />
        </section>
        <section id="home" className="tall:h-screen md:hidden">
          <HeroMobile />
        </section>
